...
extension RecorderFeatureStrings {
    static let vi = RecorderFeatureStrings(
        ...
        hubDescription: "Ghi lại một vùng, cửa sổ hoặc màn hình và chỉnh sửa sau đó",
        ...
        indicatorTooltip: "Điều khiển ghi",
        ...
        qualityHigh: "Cao",
        qualityCaption: "Cân bằng phù hợp với hầu hết nhu cầu. Cao giữ lại mọi chi tiết và tạo tệp lớn hơn.",
        frameRateLabel: "Số khung hình/giây",
        frameRateFormat: "%d fps",
        systemAudioToggle: "Ghi âm thanh máy Mac",
        systemAudioCaption: "Mọi thứ bạn nghe thấy sẽ được ghi lại trên luồng riêng để bạn có thể tắt tiếng sau.",
        folderLabel: "Lưu vào",
        folderChoose: "Chọn…",
        ...
        noSpaceMessage: "Hãy giải phóng dung lượng trên đĩa và thử lại.",
        stoppedNoSpaceHUD: "Đã dừng ghi, đĩa gần đầy",
        shortcutLabel: "Phím tắt",
        editorTitle: "Bản ghi",
        saveVideoButton: "Lưu",
        saveGIFButton: "Lưu dạng GIF",
        exportingLabel: "Đang lưu…",
        cancelButton: "Hủy",
        exportFailed: "Không thể lưu bản ghi",
        gifTooLongFormat: "Ảnh GIF có thể dài tối đa %d giây",
        gifSizeLabel: "Kích thước GIF",
        gifSizeSmall: "Nhỏ",
        gifSizeMedium: "Trung bình",
        gifSizeLarge: "Lớn",
        gifFrameRateLabel: "Độ mượt mà GIF",
        discardTitle: "Xóa bản ghi này?",
        discardMessage: "Bản ghi này chưa được lưu ở bất kỳ đâu.",
        openEditorToggle: "Mở trình chỉnh sửa sau khi ghi",
        openEditorCaption: "Bản ghi sẽ mở ra sẵn sàng để cắt, tắt tiếng và lưu. Tắt tính năng này để nhận tệp ngay lập tức.",
        lookLabel: "Kiểu dáng",
        lookRaw: "Gốc",
        lookClean: "Mượt mà",
        lookStudio: "Phòng thu",
        lookCaption: "Điểm khởi đầu. Thay đổi bất kỳ nội dung nào bên dưới và thay đổi đó sẽ được lưu giữ.",
        ...
        clickRingToggle: "Đánh dấu vị trí nhấp",
        zoomSectionLabel: "Thu phóng",
        zoomToggle: "Thu phóng theo mỗi cú nhấp",
        zoomAmountLabel: "Mức độ thu phóng",
        ...
        shapeSquare: "Vuông",
        shapeVertical: "Dọc",
        noPointerNote: "Bản ghi này không có luồng con trỏ nên không thể làm mượt. Các vị trí thu phóng thủ công vẫn hoạt động.",
        zoomLaneEmptyHint: "Nhấp vào đây để thêm thu phóng",
        removeZoom: "Xóa",
        thisZoomLabel: "Thu phóng này",
        zoomWhereLabel: "Vùng ngắm",
        zoomFollowsPointer: "Đi theo con trỏ",
        zoomPickSpot: "Chọn vị trí",
        zoomPickSpotHint: "Nhấp vào hình ảnh để chỉnh hướng ngắm",
        regenerateZooms: "Trở lại một thu phóng mỗi cú nhấp",
        backToOptions: "Tất cả tùy chọn",
        cutOutButton: "Cắt bỏ",
        cutHint: "Kéo trên dòng thời gian để chọn đoạn cần xóa",
        addTextButton: "Thêm văn bản",
        textLaneEmptyHint: "Nhấp vào đây để thêm văn bản",
        thisTextLabel: "Văn bản này",
        textPlaceholder: "Văn bản của bạn ở đây",
        ...
        discardSavedMessage: "Các tệp đã lưu và sao chép vẫn được giữ nguyên vị trí.",
        presetsButton: "Mẫu sẵn",
        savePreset: "Lưu mẫu hiện tại…",
        presetNamePlaceholder: "Tên mẫu",
        removePreset: "Xóa mẫu",
        zoomEmptyTitle: "Chưa có thu phóng nào",
        zoomEmptyCaption: "Tạo từ các cú nhấp của bạn hoặc thêm vào dòng thời gian.",
        createAutomaticZooms: "Tạo thu phóng tự động",
        typingZoomToggle: "Duy trì thu phóng khi đang gõ phím",
        typingZoomCaption: "Sau khi nhấp, việc gõ phím sẽ giữ chế độ thu phóng tự động tại vị trí đó.",
        microphoneToggle: "Ghi âm micrô",
        microphoneCaption: "Giọng nói của bạn được đưa vào luồng riêng và có thể điều chỉnh trong trình chỉnh sửa.",
        ...
        microphonePermissionExplain: "Cho phép bản ghi màn hình thu giọng nói của bạn khi bật.",
        automaticZoomToggle: "Tự động thêm thu phóng",
        automaticZoomCaption: "Tắt tùy chọn này để bắt đầu bản ghi mới không có thu phóng. Bạn vẫn có thể thêm trong trình chỉnh sửa.",
