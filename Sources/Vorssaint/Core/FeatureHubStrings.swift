...
extension FeatureHubStrings {
    static let vi = FeatureHubStrings(
        pageTitle: "Tính năng",
        intro: "Chỉ cài đặt những gì bạn dùng. Bất cứ tính năng nào bạn gỡ cài đặt sẽ biến mất khỏi toàn bộ ứng dụng và ngừng tải.",
        tabFeatures: "Tính năng",
        tabPermissions: "Quyền hạn",
        activeCountFormat: "Đã cài đặt %1$d / %2$d tính năng",
        monitorAllOffNote: "Khi tắt tất cả, phần Giám sát sẽ rời khỏi bảng điều khiển và thanh menu.",
        titleDockClick: "Nhấp vào Dock",
        titleMouseNavigation: "Nút cạnh chuột",
        titleMusicBlock: "Trình chặn ứng dụng Nhạc",
        groupWindowsDock: "Cửa sổ và Dock",
        groupMouseKeyboard: "Chuột và bàn phím",
        groupClipboardFiles: "Bảng tạm và tệp",
        groupSound: "Âm thanh",
        groupEnergyDisplay: "Năng lượng và màn hình",
        groupTools: "Công cụ",
        groupMonitor: "Giám sát hệ thống",
        permissionsIntro: "Tác dụng của từng quyền và tính năng nào sử dụng. Các quyền truy cập khác chỉ được yêu cầu khi bạn dùng đến.",
        usedByFormat: "Được dùng bởi %@",
        usedByNone: "Hiện không có tính năng nào đang bật cần quyền này.",
        unusedBanner: "Bạn đã cấp quyền này, nhưng không có tính năng đang bật nào cần dùng. Nếu muốn, bạn có thể thu hồi trong Cài đặt hệ thống.",
        ...
        permFullDisk: "Truy cập toàn phần vào đĩa",
        permFilesAndFolders: "Tệp & Thư mục",
        ...
        explainAccessibility: "Cho phép các tính năng phản hồi các cú nhấp và phím bấm, đồng thời di chuyển cửa sổ.",
        explainScreenRecording: "Cho phép các tính năng hiển thị hình thu nhỏ cửa sổ và đọc văn bản trên màn hình.",
        explainFullDisk: "Cho phép trình dọn dẹp và trình gỡ cài đặt tìm kiếm các tệp thừa ở mọi nơi.",
        explainFilesAndFolders: "Cho phép tính năng dọn dẹp tải về WhatsApp và trình sắp xếp thử nghiệm kiểm tra thư mục Tải về của bạn.",
        explainNotifications: "Cho phép ứng dụng thông báo cho bạn về các cảnh báo bạn đã bật.",
        explainAutomationFinder: "Cho phép ứng dụng yêu cầu Finder di chuyển tệp cho bạn.",
        explainAutomationTerminal: "Cho phép các lệnh Homebrew mở trong Terminal.",
        explainAudioCapture: "Cho phép bộ trộn điều chỉnh âm lượng của từng ứng dụng.",
        descSwitcher: "Chuyển đổi ứng dụng và cửa sổ kèm xem trước",
        descDockPreview: "Xem trước cửa sổ khi di chuột qua Dock",
        descDockClick: "Nhấp vào biểu tượng Dock để thu nhỏ hoặc xoay vòng cửa sổ",
        descWindowMaximizer: "Nút màu xanh lục phóng to thay vì toàn màn hình",
        descWindowLayout: "Sắp xếp cửa sổ bằng phím tắt hoặc căn mép, sau đó điều chỉnh bằng cách kéo",
        descAutoQuit: "Thoát ứng dụng khi đóng cửa sổ cuối cùng",
        descScrollInverter: "Đảo ngược hướng con lăn chuột",
        descSmoothScroll: "Cuộn chuột mượt mà có hoạt ảnh",
        descMouseNavigation: "Các nút cạnh chuột để quay lại và tiến lên",
        descMiddleClick: "Nhấp ba ngón hoạt động như nhấp chuột giữa",
        descKeyboardDebounce: "Bỏ qua các lần nhấn phím đúp vô tình",
        descClipboardHistory: "Lưu giữ lịch sử cục bộ những gì bạn sao chép",
        descPastePlain: "Dán văn bản không có định dạng",
        descFinderCutPaste: "Cắt và dán tệp trong Finder",
        descShelf: "Thả tệp vào thanh menu để giữ chúng",
        descURLCleaner: "Liên kết sao chép được loại bỏ các tham số theo dõi",
        descMixer: "Thanh trượt âm lượng riêng cho từng ứng dụng",
        descSoundOutputSwitcher: "Xoay vòng đầu ra âm thanh bằng phím tắt",
        descMicMute: "Tắt tiếng micrô từ bất kỳ đâu",
        descMusicBlock: "Ngăn ứng dụng Nhạc tự động mở",
        descKeepAwake: "Giữ máy Mac luôn thức theo yêu cầu",
        descExtraBrightness: "Tăng thêm độ sáng trên màn hình XDR",
        descQuickLauncher: "Bảng nổi chứa các công cụ ưa thích của bạn",
        descColorPicker: "Chọn bất kỳ màu nào trên màn hình",
        descScreenOCR: "Sao chép văn bản hoặc mã QR từ màn hình",
        descCleaningMode: "Khóa bàn phím và màn hình để vệ sinh",
        descMediaTools: "Nén video, hình ảnh và ảnh GIF",
        descCleaner: "Xóa bộ nhớ đệm và các tệp rác",
        descUninstaller: "Gỡ bỏ ứng dụng và tệp thừa còn lại",
        descHomebrew: "Giữ các gói Homebrew luôn cập nhật",
        descMonitorCPU: "Mức sử dụng và nhiệt độ bộ vi xử lý",
        descMonitorGPU: "Mức sử dụng đồ họa và nhiệt độ",
        descMonitorMemory: "Mức sử dụng và áp lực bộ nhớ",
        descMonitorNetwork: "Tốc độ và mức sử dụng mạng",
        descMonitorDisk: "Dung lượng và hoạt động của ổ đĩa",
        descMonitorPower: "Pin, nguồn điện và sạc",
        installButton: "Cài đặt",
        uninstallButton: "Gỡ cài đặt",
        footerNote: "Gỡ cài đặt không xóa gì cả: tính năng chỉ rời khỏi ứng dụng và ngừng tải. Cài đặt lại bất cứ lúc nào và mọi thứ sẽ trở lại như cũ.",
        restartNote: "Các tính năng đã gỡ cài đặt trong phiên này vẫn tồn tại trong bộ nhớ cho đến khi khởi động lại ứng dụng. Khởi động lại để giải phóng khỏi bộ nhớ ngay.",
        restartButton: "Khởi động lại ngay",
        installAllButton: "Cài đặt tất cả",
        uninstallAllButton: "Gỡ cài đặt tất cả",
        presetsTitle: "Bắt đầu với gói có sẵn",
        presetsCaption: "Một cú nhấp thiết lập ứng dụng phù hợp với cách bạn dùng máy Mac. Mọi thứ khác vẫn sẵn sàng chỉ với một cú nhấp.",
        presetEssentialName: "Cơ bản",
        presetEssentialDesc: "Bộ trộn âm lượng, giám sát hệ thống và giữ thức.",
        presetWindowsName: "Cửa sổ",
        presetWindowsDesc: "Trình chuyển ứng dụng, bố cục cửa sổ và các tính năng Dock.",
        presetBatteryName: "Tiết kiệm pin & Yên tĩnh",
        presetBatteryDesc: "Giám sát gọn nhẹ với pin, bộ nhớ và bộ vi xử lý. Không lắng nghe đầu vào.",
        presetApplyButton: "Áp dụng",
        presetConfirmFormat: "Cài đặt gói %1$@ và gỡ cài đặt các mục còn lại? Không có gì bị xóa và mọi thứ có thể khôi phục lại với một cú nhấp.",
        presetConfirmApply: "Áp dụng gói",
        presetConfirmCancel: "Hủy",
        energyIdle: "Không tiêu hao khi nghỉ",
        energyMouse: "Lắng nghe chuột",
        energyPointer: "Lắng nghe đầu vào con trỏ",
        energyKeyboard: "Lắng nghe bàn phím",
        energyInputs: "Lắng nghe chuột và bàn phím",
        energyPeriodic: "Kiểm tra theo chu kỳ",
        energyHelp: "Những gì tính năng duy trì hoạt động khi đang bật. Các tính năng chưa cài đặt không tải bất cứ thứ gì.",
        explainAppManagement: "Cho phép cập nhật thay thế hoặc xóa ứng dụng được cài bởi trình quản lý gói.",
        onboardingSelectedPermissionsTitle: "Quyền hạn cho lựa chọn của bạn",
        onboardingNoSelectedPermissions: "Bạn không cần cấp quyền nào để hoàn tất thiết lập.",
        onboardingOtherPermissionsTitle: "Các quyền khác",
        onboardingOtherPermissionsCaption: "Tùy chọn. Cấp các quyền này bây giờ hoặc sau này khi tính năng cần đến."
    )
