...
extension CommandBarFeatureStrings {
    static let vi = CommandBarFeatureStrings(
        ...
        hubDescription: "Một trường tìm kiếm duy nhất để tìm và chạy mọi thứ ứng dụng hỗ trợ",
        panelCaption: "Gõ để tìm và chạy bất kỳ tác vụ nào",
        settingsCaption: "Một phím tắt mở trường tìm kiếm phủ lên bất kỳ việc gì bạn đang làm. Gõ vài chữ cái, nhấn Return và lệnh được thực thi. Không có dữ liệu nào bạn gõ bị lưu lại.",
        openButton: "Mở thanh lệnh ngay",
        searchPlaceholder: "Gõ những gì bạn muốn làm",
        suggestionsLabel: "Gợi ý",
        noResultsTitle: "Không tìm thấy nội dung phù hợp.",
        ...
        kindSnippet: "Chèn đoạn trích",
        soundOutputSubtitle: "Chuyển đổi đầu ra âm thanh",
        soundOutputCurrent: "Đầu ra hiện tại",
        volumeTitle: "Âm lượng",
        brightnessTitle: "Độ sáng màn hình",
        keepAwakeForFormat: "Giữ thức trong %@",
        needsSetupFormat: "Bật %@ trong Cài đặt",
        needsPermissionHint: "Cần quyền · Return để yêu cầu",
        actionCheckAppUpdates: "Kiểm tra bản cập nhật ứng dụng",
        actionCleanURL: "Dọn dẹp liên kết đã sao chép",
        ...
        answerMemoryFormat: "%@ / %@ đang dùng",
        answerStorageLabel: "Dung lượng",
        answerStorageFormat: "%@ trống / %@",
        copyHint: "Return để sao chép",
        kindWindow: "Cửa sổ",
        quitFormat: "Thoát %@",
        quitConfirmFormat: "Thoát %@?",
        kindMenu: "Lệnh trong menu",
        actionsTitle: "Tác vụ",
        actionsHint: "Tác vụ",
        actionPin: "Ghim lên đầu",
        actionUnpin: "Bỏ ghim",
        actionName: "Đặt tên riêng",
        actionRename: "Đổi tên kích hoạt",
        actionHide: "Không bao giờ hiện mục này",
        actionForget: "Quên tần suất sử dụng",
        aliasPlaceholder: "Tên bạn muốn gọi",
        aliasTakenFormat: "%@ đã được gán cho tên đó",
        sourcesTitle: "Phạm vi tìm kiếm",
        sourcesCaption: "Tắt những gì bạn không muốn thấy. Tác vụ riêng của bạn luôn được giữ lại.",
        sourceActions: "Tác vụ Vorssaint",
        sourceApps: "Ứng dụng",
        sourceMenus: "Lệnh menu của ứng dụng đang mở",
        sourceWindows: "Cửa sổ đang mở",
        sourceQuitApps: "Thoát ứng dụng",
        sourceSettingsPages: "Trang Cài đặt",
        sourceSnippets: "Đoạn trích",
        sourceClipboard: "Lịch sử bảng tạm",
        sourceEmoji: "Biểu tượng cảm xúc",
        sourceFolders: "Thư mục",
        sourceAnswers: "Câu trả lời về máy Mac",
        sourceCalculator: "Phép tính và chuyển đổi",
        namedTitle: "Tên bạn đã đặt",
        namedEmpty: "Chưa có tên nào. Mở thanh lệnh, chọn một hàng và nhấn phím tác vụ.",
        pinnedTitle: "Đã ghim",
        pinnedEmpty: "Chưa có mục nào được ghim.",
        hiddenTitle: "Đã ẩn",
        hiddenEmpty: "Không có mục nào bị ẩn.",
        forgetAllButton: "Quên các mục hay dùng",
        tryTheseLabel: "Thử",
        stillLooking: "Vẫn đang tìm",
        removeButton: "Xóa",
        confirmButton: "Xác nhận",
        soundMute: "Tắt âm thanh",
        soundUnmute: "Bật lại âm thanh",
        stateOn: "bật",
        powerSleep: "Ngủ",
        powerRestart: "Khởi động lại",
        powerRestartConfirm: "Khởi động lại máy Mac?",
        powerShutDown: "Tắt máy",
        powerShutDownConfirm: "Tắt máy Mac?",
        powerLogOut: "Đăng xuất",
        powerLogOutConfirm: "Đăng xuất?",
        wifiOn: "Bật Wi-Fi",
        wifiOff: "Tắt Wi-Fi",
        kindEmoji: "Biểu tượng cảm xúc",
        kindFolder: "Thư mục",
        answerDateLabel: "Hôm nay",
        answerTimeLabel: "Bây giờ",
        kindAnswer: "Câu trả lời",
        kindSelection: "Đoạn chọn",
        selectedTitle: "Đã chọn",
        selectionCopy: "Sao chép",
        selectionSearch: "Tìm kiếm bằng đoạn này",
        selectionUpper: "CHỮ HOA",
        selectionLower: "chữ thường",
        selectionTitleCase: "Viết Hoa Chữ Đầu",
        selectionShelf: "Giữ trên kệ tạm",
        selectionCount: "Đếm",
        selectionCountFormat: "%d từ, %d ký tự",
        sourceSelection: "Nội dung đang chọn",
        kindLink: "Phím tắt riêng của bạn",
        linkSearchHint: "Gõ nội dung cần tìm sau tên",
        linksTitle: "Phím tắt riêng của bạn",
        linksEmpty: "Chưa lưu mục nào. Thêm trang web, thư mục, tìm kiếm hoặc tập lệnh bạn dùng hàng ngày.",
        linkDestinationLabel: "Đích đến",
        linkKindLink: "Trang web hoặc liên kết",
        linkKindPlace: "Thư mục hoặc tệp",
        linkPlaceholdersHint: "Thêm một biến giữ chỗ và nó sẽ được điền khi mở",
        placeholderQuery: "những gì bạn gõ",
        placeholderClipboard: "những gì bạn đã sao chép",
        placeholderSelection: "những gì đang được chọn",
        placeholderDate: "hôm nay",
        privacyNote: "Mọi thứ diễn ra trên máy Mac này: không tài khoản, không đám mây, không gửi dữ liệu đi đâu.",
        actionShortcut: "Gán phím tắt",
        actionShortcutChange: "Thay đổi phím tắt",
        actionShortcutRemove: "Gỡ phím tắt",
        shortcutCaptureHint: "Nhấn các phím bạn muốn · Delete để xóa · Esc để quay lại",
        rowShortcutsTitle: "Các hàng có phím tắt riêng",
        rowShortcutsEmpty: "Chưa có hàng nào có phím tắt riêng. Mở tác vụ trên bất kỳ hàng nào để gán.",
        turnOnFormat: "Bật %@",
        turnOffFormat: "Tắt %@",
        everythingTitle: "Mọi tác vụ có thể làm",
        categoryAll: "Tất cả",
        restartAppFormat: "Khởi động lại %@",
        forceQuitAppFormat: "Bắt buộc thoát %@…",
        forceQuitAppConfirmFormat: "Bắt buộc thoát %@? Mọi thay đổi chưa lưu sẽ bị mất.",
        uninstallAppFormat: "Gỡ cài đặt %@…",
        openInBrowser: "Mở trong trình duyệt",
        linkKindScript: "Tập lệnh",
        scriptHint: "Chọn một tệp thực thi. Gõ tên tệp kèm nội dung bạn muốn gửi. Tập lệnh sẽ chạy khi bạn dừng gõ và hiển thị kết quả tại đây.",
        scriptRunsWithoutArgument: "Cũng chạy khi chỉ gõ tên riêng của nó",
        scriptRunFailed: "Không thể chạy tệp này",
        scriptSearchHint: "Gõ nội dung cần gửi sau tên",
        scriptBareSearchHint: "Tự chạy hoặc gõ nội dung cần gửi",
        linkAddButton: "Thêm phím tắt",
        positionCaption: "Kéo dấu ở bên trái trường để đặt thanh lệnh ở bất kỳ đâu trên màn hình; nhấp đúp vào dấu để căn giữa lại.",
        resetPositionButton: "Căn giữa lại thanh lệnh",
        shortcutToggle: "Phím tắt toàn hệ thống để mở thanh lệnh",
        dragHint: "Kéo để di chuyển · Nhấp đúp để căn giữa",
        actionRevealInFinder: "Hiện trong Finder",
        sourceMacSettings: "Ngăn Cài đặt hệ thống",
        sourceFiles: "Tệp",
        filesTitle: "Tìm kiếm tệp của bạn",
        filesCaption: "Đặt tên cho các thư mục cần tìm và thanh lệnh sẽ tìm tệp theo tên khi bạn gõ. Không lập chỉ mục và không yêu cầu quyền: sử dụng tìm kiếm của chính máy Mac và chỉ hiển thị những gì bạn có thể thấy trong Finder.",
        filesEmpty: "Chưa có thư mục nào, vì vậy thanh lệnh không tìm kiếm tệp.",
        filesAddFolder: "Thêm thư mục",
        filesIgnoreCaption: "Tên không bao giờ cần hiện: toàn bộ tên thư mục hoặc tệp, hoặc phần mở rộng được viết dưới dạng *.log.",
        filesIgnorePlaceholder: "Tên thư mục hoặc tệp",
        filesIgnoreAdd: "Thêm",
        compactModeToggle: "Chế độ thu gọn",
        compactModeCaption: "Thanh lệnh mở mà không có gợi ý. Kết quả xuất hiện khi bạn gõ.")
