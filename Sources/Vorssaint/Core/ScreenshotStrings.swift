...
extension ScreenshotFeatureStrings {
    static let vi = ScreenshotFeatureStrings(
        ...
        hubDescription: "Chụp một vùng, cửa sổ hoặc màn hình và thêm chú thích",
        captureButton: "Chụp ngay",
        panelCaption: "Chụp một vùng, cửa sổ hoặc toàn bộ màn hình",
        fileNamePrefix: "Ảnh chụp màn hình",
        hintDrag: "Kéo để chọn một vùng",
        hintClick: "Nhấp vào cửa sổ để chụp",
        hintFullScreen: "Nhấn Return để chụp toàn bộ màn hình",
        hintCancel: "Nhấn Esc để hủy",
        hintRepeat: "Nhấn R để chụp lại vùng gần nhất",
        freezeToggle: "Đóng băng màn hình khi chọn",
        freezeCaption: "Hình ảnh tạm dừng trong khi bạn chọn vùng, giúp tránh bị xê dịch hoặc thay đổi trong khi chọn.",
        folderLabel: "Lưu vào",
        folderChoose: "Chọn…",
        subfolderLabel: "Mẫu thư mục con",
        subfolderCaption: "Tùy chọn. Tạo các thư mục con theo ngày bên trong thư mục trên bằng %y, %year, %mo, %month, %d, %h, %mi và %s, ví dụ %y-%mo cho 24-03.",
        fileNamePatternLabel: "Tên tệp",
        fileNamePatternCaption: "Tùy chọn. Ghi đè tên mặc định bằng các thẻ %y, %year, %mo, %month, %d, %h, %mi và %s, cùng với %# cho số tự tăng (%## đệm 2 chữ số, %### đệm 3 chữ số, v.v.).",
        fileNumberStartLabel: "Bắt đầu tại",
        ...
        downscaleCaption: "Ảnh chụp Retina được lưu ở một nửa số pixel, giúp tệp nhỏ hơn.",
        editorTitle: "Ảnh chụp màn hình",
        toolShortcutsTitle: "Công cụ chỉnh sửa",
        toolShortcutsToggle: "Dùng phím tắt số",
        toolShortcutsCaption: "Dùng các phím mũi tên hoặc chọn một số. Chín công cụ đầu tiên dùng từ 1 đến 9. Các công cụ khác không có phím tắt.",
        toolSelect: "Chọn",
        toolArrow: "Mũi tên",
        ...
        toolPixelate: "Làm mờ điểm ảnh",
        toolRedact: "Che khối đen",
        toolCrop: "Cắt xén",
        ...
        discardTitle: "Hủy ảnh chụp màn hình này?",
        discardMessage: "Ảnh chưa được sao chép hoặc lưu vào đâu.",
        ...
        defaultActionLabel: "Tác vụ mặc định",
        defaultActionCaption: "Tự động chạy ngay sau khi chụp. Hộp thoại xác nhận vẫn xuất hiện để bạn có thể Chỉnh sửa hoặc hủy sau.",
        defaultActionNone: "Hỏi mỗi lần",
        defaultActionSaveAndCopy: "Lưu & Sao chép",
        captureFailed: "Không thể chụp màn hình",
        pinOpacity: "Độ mờ đục",
        pinClickThrough: "Bỏ qua cú nhấp chuột",
        pinCloseAll: "Đóng tất cả các ghim",
        backdropPaddingLabel: "Khoảng đệm",
        backdropWallpaperLabel: "Hình nền máy Mac",
        backdropImageButton: "Hình ảnh…",
        backdropSolidLabel: "Màu đơn",
        backdropGradientLabel: "Màu chuyển sắc",
        backdropCornersLabel: "Bo góc",
        backdropSavePreset: "Lưu hình nền",
        backdropDeletePreset: "Xóa",
        backdropCustomLabel: "Tùy chỉnh",
        openEditorToggle: "Mở trình chỉnh sửa ngay sau khi chụp",
        openEditorCaption: "Ảnh chụp bỏ qua bản xem trước nổi và mở sẵn sàng để thêm chú thích.",
        autoCopyToggle: "Tự động sao chép vào bảng tạm",
        autoCopyCaption: "Mỗi ảnh chụp sẽ tự động vào bảng tạm ngay sau khi chụp, sẵn sàng để dán. Lưu thành tệp vẫn là tùy chọn riêng.",
        hintLoupe: "Nhấn Z để bật kính lúp",
        lastRegionToggle: "Hiện đường viền vùng chụp gần nhất",
        backdropBlurLabel: "Làm mờ",
        scrollingCaptureButton: "Chụp cuộn trang",
        scrollingCaptureTitle: "Ảnh chụp màn hình cuộn trang",
        scrollingCaptureProgressHUD: "Cuộn bằng chuột hoặc bàn di chuột. Nhấn Enter hoặc chọn Xong.",
        scrollingCaptureHintOff: "Nhấn S để bật cuộn",
        scrollingCaptureHintOn: "Đang bật cuộn",
        scrollingCaptureTooLongHUD: "Đã dừng chụp tại giới hạn an toàn",
        editLastCapture: "Chỉnh sửa ảnh chụp gần nhất",
        lastCaptureMissing: "Hãy chụp ảnh màn hình trước",
        ...
        sharedLinksEmpty: "Không có liên kết đang hoạt động",
        ...
        sharePrivacyTitle: "Quyền riêng tư cho liên kết tạm thời",
        sharePrivacyData: "Vorssaint chỉ gửi hình ảnh đã xuất và thời hạn bạn chọn. Không gửi tên, tài khoản, định danh thiết bị hay địa chỉ MAC. Trên máy Mac này, chỉ lưu liên kết, thời hạn và mã xóa riêng tư trong thời gian liên kết còn hiệu lực.",
        sharePrivacyStorage: "Các nhà cung cấp mạng và dịch vụ xử lý tạm thời IP công khai của bạn để ngăn chặn lạm dụng. Hình ảnh và siêu dữ liệu liên kết sẽ bị xóa vĩnh viễn khi bạn xóa liên kết hoặc hết hạn. Dịch vụ không tạo bản sao lưu ảnh chụp màn hình.",
        sharePrivacyAccess: "Bất kỳ ai có liên kết đều có thể xem, tải về, lưu hoặc phân phối lại hình ảnh. Các liên kết đang hoạt động có thể được người vận hành dịch vụ kiểm duyệt. Chỉ chia sẻ với những người bạn tin tưởng.",
        scrollingCaptureCaption: "Chọn một vùng, cuộn bằng chuột hoặc bàn di chuột, sau đó nhấn Enter hoặc Xong để ghép ảnh.",
        scrollingCaptureSelectionHint: "Chỉ kéo phần chuyển động của trang.",
        ...
        previewPositionTopLeft: "Trên cùng bên trái",
        previewPositionTopRight: "Trên cùng bên phải",
        previewPositionBottomLeft: "Dưới cùng bên trái",
        previewPositionBottomRight: "Dưới cùng bên phải",
        hideVorssaintWindowsToggle: "Ẩn các cửa sổ Vorssaint",
        shareEnabledToggle: "Cho phép liên kết tạm thời",
        editClipboardImage: "Chỉnh sửa hình ảnh trong bảng tạm",
