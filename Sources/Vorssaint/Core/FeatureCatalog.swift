...
enum AppFeature: String, CaseIterable {
    ...
    case quickLauncher, quickToggles, colorPicker, screenOCR, cleaningMode, mediaTools,
         ...
         commandBar, screenRecorder, killProcess, webBar
...
extension AppFeature {
    ...
    func monitorsPermissionChanges(boolFor: (String) -> Bool) -> Bool {
        ...
        case .screenOCR, .cleaningMode, .screenshot, .commandBar, .screenRecorder, .webBar:
            return false
        default:
            return true
        }
    ...
    var group: FeatureGroup {
        ...
        case .quickLauncher, .quickToggles, .colorPicker, .screenOCR, .cleaningMode, .mediaTools,
             ...
             .scratchpad, .commandBar, .screenRecorder, .killProcess, .webBar:
            return .tools
    ...
    var permissions: [AppPermission] {
        ...
        case .clipboardHistory, .shelf, .urlCleaner,
             ...
             .scratchpad, .monitorGPU, .monitorNetwork, .fanControl, .killProcess, .webBar:
            return []
        }
    }
