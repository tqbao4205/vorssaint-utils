...
struct WindowDirectionalStrings {
    ...
    static func localized(_ language: AppLanguage) -> WindowDirectionalStrings {
        ...
        case .vi: return .init(title: "Bố cục phím tắt + con trỏ", caption: "Giữ phím tắt, di chuyển con trỏ về phía mép hoặc góc, sau đó thả ra để đặt cửa sổ đang hoạt động.")
        }
    }
}
