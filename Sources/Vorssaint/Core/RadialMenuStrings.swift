...
extension RadialMenuFeatureStrings {
    static let vi = RadialMenuFeatureStrings(
        pageTitle: "Menu tròn",
        hubDescription: "Mở một vòng tròn chứa các tác vụ ưa thích xung quanh con trỏ",
        enableLabel: "Sử dụng menu tròn",
        enableCaption: "Giữ phím tắt, trỏ vào một tác vụ và thả ra. Nhấn nhanh để giữ menu luôn mở.",
        positionLabel: "Vị trí mở",
        positionPointer: "Tại vị trí con trỏ",
        positionCenter: "Tại giữa màn hình",
        tryButton: "Dùng thử",
        actionsHeader: "Tác vụ",
        addButton: "Thêm tác vụ",
        limitCaption: "Một vòng tròn chứa tối đa 12 tác vụ.",
        emptyCaption: "Chưa có tác vụ nào ở đây.",
        backButton: "Quay lại",
        editActionsButton: "Sửa tác vụ",
        nameLabel: "Tên",
        ...
        submenuCaption: "Mở vòng tròn thứ hai với các tác vụ riêng.",
        saveButton: "Lưu",
        deleteButton: "Xóa",
        permissionCaption: "Các tác vụ phím và kích hoạt bằng nút chuột bên cạnh cần quyền Trợ năng.",
        manageButton: "Quản lý menu",
        panelCaption: "Các tác vụ ưa thích của bạn trên một vòng tròn",
        mouseTriggerLabel: "Nút chuột",
        mouseTriggerOff: "Tắt",
        mouseTriggerBack: "Nút cạnh Quay lại",
        mouseTriggerForward: "Nút cạnh Tiến lên",
        mouseTriggerWarning: "Khi bật tính năng này, nút đó sẽ không còn quay lại hoặc tiến lên trong ứng dụng. Nếu bạn dùng để điều hướng, hãy để tắt.",
        ...
        buttonTestHint: "Nếu không có phản hồi, macOS không gửi nút đó tới ứng dụng. Chuột có phần mềm riêng thường gán nút cạnh thành chức năng khác. Hãy đổi lại trong phần mềm đó hoặc gán tổ hợp phím.",
        activationModeLabel: "Hành vi mở",
        activationModePressOrHold: "Nhấn hoặc giữ",
        activationModePress: "Nhấn để mở",
        activationModeHold: "Giữ để chọn",
        activationModeCaption: "Nhấn hoặc giữ duy trì cử chỉ thích ứng hiện tại. Nhấn để giữ mở; giữ để thực thi tác vụ được làm nổi bật khi thả tay.",
        ...
        presetQuickToggles: "Thao tác nhanh",
        presetBlank: "Trống",
        colorAccent: "Màu chủ đạo",
        colorBlue: "Xanh lam",
        colorPurple: "Tím",
        colorPink: "Hồng",
        colorRed: "Đỏ",
        ...
        colorGreen: "Xanh lục",
        colorMint: "Bạc hà",
        colorCyan: "Xanh lục lam",
        colorIndigo: "Chàm",
        colorGraphite: "Than chì",
        fetchFaviconButton: "Tải biểu tượng trang web",
        fetchFaviconDisclaimer: "Kết nối đến trang web một lần để tải biểu tượng. Được lưu cục bộ.",
        fetchFaviconLoading: "Đang tải biểu tượng…",
