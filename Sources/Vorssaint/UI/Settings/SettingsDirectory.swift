    ...
    static func sections(_ s: Strings,
        ...
        return [
            ...
            (categories.utilities, [
                ...
                SettingsDirectoryItem(page: .webBar,
                                      title: FeatureStrings.webBar(language).pageTitle,
                                      icon: "globe",
                                      keywords: [FeatureStrings.webBar(language).searchPlaceholder,
                                                 FeatureStrings.webBar(language).quickAppsTitle,
                                                 FeatureStrings.webBar(language).viewportLabel,
                                                 FeatureStrings.webBar(language).shortcutLabel]),
